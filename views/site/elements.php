...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?=Yii::$app->urlManager->baseUrl?>img/core-img/favicon.ico">
                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            <div class="academy-logo">
                                <a href="index.html"><img src="<?=Yii::$app->urlManager->baseUrl?>/img/core-img/logo.png" alt=""></a>
                            </div>
                                    ...
                                    <li><a href="#">Mega Menu</a>
                                        <div class="megamenu">
                                            ...
                                            <div class="single-mega cn-col-4">
                                                <img src="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/bg-1.jpg" alt="">
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="about-us.html">About Us</a></li>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget mb-100">
                            <div class="widget-title">
                                <a href="#"><img src="<?=Yii::$app->urlManager->baseUrl?>/img/core-img/logo2.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget mb-100">
                            ...
                            <div class="gallery-list d-flex justify-content-between flex-wrap">
                                <a href="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery1.jpg" class="gallery-img" title="Gallery Image 1"><img src="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery1.jpg" alt=""></a>
                                <a href="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery2.jpg" class="gallery-img" title="Gallery Image 2"><img src="img/bg-img/gallery2.jpg" alt=""></a>
                                <a href="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery3.jpg" class="gallery-img" title="Gallery Image 3"><img src="img/bg-img/gallery3.jpg" alt=""></a>
                                <a href="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery4.jpg" class="gallery-img" title="Gallery Image 4"><img src="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery4.jpg" alt=""></a>
                                <a href="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery5.jpg" class="gallery-img" title="Gallery Image 5"><img src="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery5.jpg" alt=""></a>
                                <a href="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery6.jpg" class="gallery-img" title="Gallery Image 6"><img src="<?=Yii::$app->urlManager->baseUrl?>/img/bg-img/gallery6.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!-- Footer Widget Area -->
