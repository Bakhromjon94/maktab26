...
?>
<div class="container">
  <div class="col-lg-2 div-md-2 col-sm-2 col-xs-2"></div>
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
<?php $sum=count($yangiliklar)+count($qoshimchadarslar)+count($about);?>
...
<div class="col-lg-12 col-md-12 col-sm-12 content">
            <div class="more">
              ...
              <p>
                <?php if(strlen($u->matn)>100):?>
                  <?=substr($u->matn,0,100)."...";?>
                <?php else:?>
                  <?=$u->matn;?>
                <?php endif;?>
                
                <a class="more" href="<?=Yii::$app->urlManager->createUrl(['site/kurslar','id'=>$u->id])?>">Batafsil</ a>
              </p>
            </div>
</div>
<?php endforeach;?>
